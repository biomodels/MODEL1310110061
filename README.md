# MODEL1310110061: MODEL1310110061
...
`pip install git+https://github.com/biomodels/MODEL1310110061.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110061.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110061 as model`
...
Thiele2013 - Vulva anal skin epidermal cells

The model of vulva anal skin epidermal cells metabolism is derived from the
...
and identified by:
[MODEL1310110061](http://identifiers.org/biomodels.db/MODEL1310110061) .
